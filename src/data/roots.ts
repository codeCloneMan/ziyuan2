 ...
 * 力变、天变、㐄、㐫、㡀、䶹、U+E16B、U+E472、U+E51A、U+475F3。
 * 上述字根在 2026-09 的全量目视核验中确认图集里没有可归属的裁剪图
 * （如 d/y/f/a 键的全部裁剪都能对上可渲染字根，没有老变/立变/礻变/力变）。
 *
 * U+32FE3（s 键）→ s (3).png：s 键裁剪恰 6 张 = 表内 6 字根，民/人/乑/屰/亻
 * 各有归属后剩余 1 张（斤形），一一对应穷举唯一指认。
 */
export const ROOT_IMAGE_MANIFEST: Record<number, string> = {
  0x32FE3: 's (3).png', // 扩展G 变体字根（斤形），s 键 6 图 = 6 根穷举指认
